      ...
      get(reportTemplateRef)
        .then((snapshot) => {
          if (snapshot.exists()) {
            ...
            {
              alert("Sorry! You Are trying customisze Document Report, This Page is for Hybrid Customization, So You are Redirected to Document Customization.");
              navigate(`/ReportDocumentCustomization/${reportTempId}`);
            }
            if(data.type!="Tabular Report")
                {
                  alert("Sorry! You Are trying customisze Tabular Report, This Page is for Hybrid Customization, So You are Redirected to Tabular Customization.");
